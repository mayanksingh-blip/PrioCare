...
const PredictionResult = () => {
  ...
  const isEmergency =
    prediction.random_forest_prediction === 'emergency' ||
    prediction.logistic_regression_prediction === 'emergency';
  const modelsAgree =
    prediction.random_forest_prediction === prediction.logistic_regression_prediction;
    ...
    <Box sx={{ minHeight: '100vh', background: '#f7fafd', py: 6 }}>
      <Container maxWidth="sm">
        ...
        <Paper elevation={3} sx={{ p: { xs: 2, sm: 4 }, borderRadius: 4, textAlign: 'center' }}>
          ...
          <Chip
            ...
            label={
              isEmergency
                ...
                : 'No Emergency Admission Required'
            }
          ...
          <Paper
            elevation={0}
            sx={{ p: 2, background: '#f8f9fa', borderRadius: 2, mb: 3 }}
          >
              ...
              >
                ...
                <Stack spacing={3} alignItems="center">
                  ...
                  <Box textAlign="center">
                    ...
                    <Chip
                      icon={getPredictionIcon(
                        prediction.logistic_regression_prediction
                      )}
                      label={getPredictionLabel(
                        prediction.logistic_regression_prediction
                      )}
                ...
                <Typography
                  variant="subtitle1"
                  color={modelsAgree ? 'success.main' : 'warning.main'}
                >
                  {modelsAgree
